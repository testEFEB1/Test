...
class Mage_Reports_Model_Resource_Product_Collection extends Mage_Catalog_Model_Resource_Product_Collection
{
    ...
    public function addOrderedQty($from = '', $to = '')
    {
        ...
        $this->getSelect()->reset()
            ...
            ->joinLeft(
                ...
                'order_items.product_id=inventory.product_id',
                array(
                    'qty' => 'inventory.qty',
                ))
    ...
    {
	$_sort = Mage::app()->getRequest()->getParam('sort');
	$_dir = Mage::app()->getRequest()->getParam('dir');
	if (isset($_sort) && isset($_dir)) {
   
       		$this ->getSelect()->order("$_sort $_dir");
	}
